...
namespace ProyectoControlCondominioView {
	...
	/// <summary>
	/// Resumen de frmEditarGuardia
	/// </summary>
	public ref class frmEditarGuardia : public System::Windows::Forms::Form
	{
	public:
		frmEditarGuardia(void)
		{
			InitializeComponent();
			//
		...
		frmEditarGuardia(Guardia^ objGuardia)
		{
			InitializeComponent();
			//
			this->objGuardia = objGuardia;
			//TODO: agregar código de constructor aquí
			//
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmEditarGuardia::typeid));
			...
			this->Datos->Location = System::Drawing::Point(26, 53);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarGuardia::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarGuardia::button1_Click);
			// 
			// label5
			// 
			...
			this->ClientSize = System::Drawing::Size(450, 440);
			this->Controls->Add(this->Datos);
			this->Name = L"frmEditarGuardia";
			this->Text = L"frmEditarGuardia";
			this->Load += gcnew System::EventHandler(this, &frmEditarGuardia::frmEditarGuardia_Load);
...
#pragma endregion
	private: System::Void frmEditarGuardia_Load(System::Object^ sender, System::EventArgs^ e) {
		this->textBox2->Text = objGuardia->getNombres();
		this->textBox3->Text = objGuardia->getApellidoPaterno();
		this->textBox4->Text = objGuardia->getApellidoMaterno();
		this->textBox5->Text = objGuardia->getDni();
		this->textBox6->Text = Convert::ToString(objGuardia->getSueldo());
		this->textBox1->Text = objGuardia->getContraseña();
		this->comboBox1->Text = objGuardia->getCategoria();
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int codigo = objGuardia->getCodigoGuardia();
		...
		objGuardiaController->actualizarGuardia(codigo,nombre, apellidoPaterno, apellidoMaterno, dni, sueldo, contraseña, categoria);
		MessageBox::Show("El guardia se ha actualizado");
		this->Close();
	}
};
}
