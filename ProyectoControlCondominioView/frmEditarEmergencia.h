...
namespace ProyectoControlCondominioView {
	...
	/// <summary>
	/// Resumen de frmEditarEmergencia
	/// </summary>
	public ref class frmEditarEmergencia : public System::Windows::Forms::Form
	{
	public:
		frmEditarEmergencia(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Datos->Location = System::Drawing::Point(20, 60);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(258, 315);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(87, 315);
			...
			this->ClientSize = System::Drawing::Size(539, 501);
			this->Controls->Add(this->Datos);
			this->Name = L"frmEditarEmergencia";
			this->Text = L"frmEditarEmergencia";
